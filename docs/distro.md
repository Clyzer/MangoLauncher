...
The most up to date and accurate descriptions of the distribution spec can be viewed in [mangos-distribution-types](https://github.com/dscalzi/mangos-distribution-types).
